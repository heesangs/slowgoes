...
export const AI_ERRORS = {
  ...
  /** 서버 응답 자체가 오지 않은 경우 — 네트워크 끊김·요청 시간 초과 (서버가 돌려준 에러와 구분) */
  NO_RESPONSE: "응답을 받지 못했어요. 네트워크 상태를 확인하고 다시 시도해주세요.",
  /** 우리가 먼저 끊은 경우 — 플랫폼이 함수를 끊어 응답이 통째로 사라지는 것보다 낫다 */
  TIMEOUT: "AI 응답이 너무 오래 걸려 중단했어요. 잠시 후 다시 시도해주세요.",
