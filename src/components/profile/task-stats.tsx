    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card>
          <CardContent className="flex flex-col items-center py-4">
            ...
            <span className="text-xs text-label-alt">{FEATURE_NAMES.DAILY_TODO}</span>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex flex-col items-center py-4">
            <span className="text-2xl font-bold">{stats.totalRoutines}</span>
            <span className="text-xs text-label-alt">{FEATURE_NAMES.ROUTINE}</span>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex flex-col items-center py-4">
            <span className="text-2xl font-bold">{stats.totalActionsCompleted}</span>
            <span className="text-xs text-label-alt">누적 완료 행동</span>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex flex-col items-center py-4">
            <span className="text-2xl font-bold">{stats.completedInLast14Days}</span>
            <span className="text-xs text-label-alt">최근 14일 완료</span>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardContent className="flex flex-col gap-2 py-4">
          ...
          <p className="text-xs text-label-alt">실행 완료율(참고): {completionRate}%</p>
        </CardContent>
      </Card>
